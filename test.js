...
(document.getElementById("button")).addEventListener('click',function(){
    ...
    if (isDark===true){
        ...
        document.getElementById("button").className="rounded-xl hover:border-orange-400 hover:bg-orange-300 cursor-pointer text-black p-2 bg-orange-600 transition-all duration-1000"
        document.getElementsByTagName("h1")[0].innerText="Light Theme"
        document.getElementsByTagName("h1")[0].className="transform -translate-y-5 text-black transition ease-in-out duration-1000"
        isDark=false
    }
    else{
